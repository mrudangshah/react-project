...
<ul>
    ...
    <li>
        ...
        <?php
            printf(
                esc_html__('Enter your Stripe publishable API key (test or live). You can get all your keys from %1$syour account page%2$s, or find out about %3$slivemode and testing%4$s.', 'event_espresso'),
